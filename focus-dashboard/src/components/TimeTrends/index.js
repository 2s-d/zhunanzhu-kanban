...
const TimeTrends = () => {
    ...
    const timeRange = useSelector((state) => state.appData.timeRange);
    ...
    return (_jsxs("div", { className: "time-trends", children: [_jsx(Card, { style: { marginBottom: 16 }, children: _jsx("div", { style: { marginBottom: 16, textAlign: 'center' }, children: _jsx(Segmented, { options: [
                            { label: '今天', value: 'today' },
                            { label: '本周', value: 'week' },
                            { label: '本月', value: 'month' },
                            { label: '全部', value: 'all' },
                        ], value: timeRange, onChange: (value) => dispatch(setTimeRange(value)) }) }) }), _jsxs(Row, { gutter: [16, 16], children: [_jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: dailyTrendOption, style: { height: '400px' } }) }) }), _jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: pointsTrendOption, style: { height: '400px' } }) }) })] }), _jsxs(Row, { gutter: [16, 16], style: { marginTop: 16 }, children: [_jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: weeklyChartOption, style: { height: '400px' } }) }) }), _jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: periodDistributionOption, style: { height: '400px' } }) }) })] })] }));
};
