...
const StudyHabits = () => {
    ...
    return (_jsxs("div", { className: "study-habits", children: [_jsxs(Row, { gutter: [16, 16], style: { marginBottom: 16 }, children: [_jsx(Col, { xs: 24, sm: 12, md: 8, children: _jsxs(Card, { children: [_jsx(Statistic, { title: "\u5E73\u5747\u5355\u6B21\u5B66\u4E60\u65F6\u957F", value: avgSessionDuration, suffix: "\u5206\u949F", valueStyle: { color: '#3f8600' } }), _jsx("div", { style: { marginTop: 8, fontSize: 12, color: '#888' }, children: formatDuration(avgSessionDuration) })] }) }), _jsx(Col, { xs: 24, sm: 12, md: 8, children: _jsx(Card, { children: _jsx(Statistic, { title: "\u5B66\u4E60\u4F1A\u8BDD\u603B\u6570", value: sessionDistribution.reduce((sum, d) => sum + d.count, 0), suffix: "\u6B21", valueStyle: { color: '#1890ff' } }) }) }), _jsx(Col, { xs: 24, sm: 12, md: 8, children: _jsxs(Card, { children: [_jsx(Statistic, { title: "\u5B66\u4E60\u6548\u7387\u8BC4\u5206", value: efficiencyScore, suffix: "/ 100", valueStyle: { color: '#cf1322' } }), _jsx("div", { style: { marginTop: 8, fontSize: 12, color: '#888' }, children: efficiencyScore >= 80 ? '优秀' : efficiencyScore >= 60 ? '良好' : '需努力' })] }) })] }), _jsxs(Row, { gutter: [16, 16], children: [_jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: sessionDistributionOption, style: { height: '400px' } }) }) }), _jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: restFrequencyOption, style: { height: '400px' } }) }) })] }), _jsxs(Row, { gutter: [16, 16], style: { marginTop: 16 }, children: [_jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: efficiencyRadarOption, style: { height: '400px' } }) }) }), _jsx(Col, { xs: 24, lg: 12, children: _jsx(Card, { children: _jsx(ReactECharts, { option: weeklyHeatmapOption, style: { height: '400px' } }) }) })] })] }));
};
